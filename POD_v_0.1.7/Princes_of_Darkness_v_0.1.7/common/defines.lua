...
NDiplomacy = {
	...
	DEMAND_RELIGIOUS_CONVERSION_INTERACTION_PIETY = 1000000,
...
NCharacter = {
	...
	PORTRAIT_MID_AGE_THRESHOLD = 240,				-- Middle age switch for character portraits
	PORTRAIT_OLD_AGE_THRESHOLD = 1600,				-- Old age switch for character portraits
...
NMilitary = {
	...
	MERCENARY_MAINTENANCE_FACTOR = 100.0,				-- Maintenance factor for NORMAL mercenary units
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 0.5,		-- Maintenance factor for VASSALIZED mercenary units
	MERCENARY_HIRE_COST_FACTOR = 1.0,				-- Hire cost factor for mercenary units
