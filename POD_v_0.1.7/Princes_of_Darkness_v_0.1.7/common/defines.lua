...
NDiplomacy = {
	...
	MAX_DIPLO_DISTANCE_SAME_RELIGION = 200,		-- Bonus to max diplo distance for being of the same religion
	MAX_DIPLO_DISTANCE_SAME_RELIGION_GROUP = 100, -- Bonus to max diplo distance for being of the same religion group
	MAX_DIPLO_DISTANCE_SAME_CULTURE = 200, 		-- Bonus to max diplo distance for being of the same culture
...
NMilitary = {
	...
	MERCENARY_MAINTENANCE_FACTOR = 10.0,				-- Maintenance factor for NORMAL mercenary units
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 0.5,		-- Maintenance factor for VASSALIZED mercenary units
	MERCENARY_HIRE_COST_FACTOR = 0.5,				-- Hire cost factor for mercenary units
	HOLY_ORDER_HIRE_COST_FACTOR = 1.0,				-- Conversion of nominal gold cost to piety cost when hiring Holy Orders
...
NTechnology = {
	...
	IDEAL_YEAR_LEVEL_0 = 1100, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	...
	END_REN_CLOSE       = 4.0, -- Tech level at the center of the renaissance
	END_REN_FAR         = 1.0, -- Tech level on the fringe of the renaissance
	REN_PROVINCE        = 333, -- Province where the Renaissance is centered
	...
	START_ECO_INDIAN    = 0.0,
	START_CUL_INDIAN    = 0.0,
	END_MIL_INDIAN   	= 0.0,
	END_ECO_INDIAN    	= 0.0,
	END_CUL_INDIAN    	= 0.0,
	START_MIL_OTHER     = 0.0,
...
NAI =
{
	...
	MAX_KING_TITLES_TO_CREATE = 3,							-- AI will not seek to create/usurp more King-level titles than this (0 for unlimited)
	...
	BASE_AI_ARMY_SIZE = 100,								-- Base size that AI will use when forming armies (multiplied by supply tech)
